                                        ...
                                        <div class="card-body">
                                            <form id="frmQuestion" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                                ...
                                                <?php if ($question_id != '') { ?>
                                                    ...
                                                    <input type="hidden" id="image_url" name="image_url" value="<?= ($question_id != '') ? ((!empty($data)) ? (($data[0]->image != '') ? QUESTION_IMG_PATH . $data[0]->image : '') : '') : '' ?>">
                                                <?php } ?> 
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <?php if($question_id != '' && isset($data[0]->image) && !empty($data[0]->image)) { ?> 
                                                            <div class="m-2"><img src="<?=base_url() . QUESTION_IMG_PATH . $data[0]->image?>" alt="logo" width="40" height="40"></div> 
                                                        <?php } ?>
                                                    </div>     
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <input type='number' name='level' class='form-control' required min="0" value="<?= ($question_id !=  '') ? ((!empty($data)) ? $data[0]->level : '') : "" ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">                                                    
                                                    <div class="col-md-12 col-sm-12">
