...
<head>
    ...
    <title>Web Home Settings | <?php echo ($app_name) ? $app_name['message'] : "" ?></title>
                                        ...
                                        <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-4 col-sm-6">
                                                    <label class="control-label">Visibility Mode</label>
                                                    <label class="custom-switch d-block pl-0">
                                                        <input type="checkbox" id="section-1-mode" data-plugin="switchery" <?php if (!empty($section_1_mode) && $section_1_mode['message'] == '1') { echo 'checked'; } ?>>
                                                    </label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-4 col-sm-6">
                                                    <label class="control-label">Visibility Mode</label>
                                                    <label class="custom-switch d-block pl-0">
                                                        <input type="checkbox" id="section-2-mode" data-plugin="switchery" <?php if (!empty($section_2_mode) && $section_2_mode['message'] == '1') { echo 'checked'; } ?>>
                                                    </label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-4 col-sm-6">
                                                    <label class="control-label">Visibility Mode</label>
                                                    <label class="custom-switch d-block pl-0">
                                                        <input type="checkbox" id="section-3-mode" data-plugin="switchery" <?php if (!empty($section_3_mode) && $section_3_mode['message'] == '1') { echo 'checked'; } ?>>
                                                    </label>
